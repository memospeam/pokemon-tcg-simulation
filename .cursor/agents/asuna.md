...
description: >-
  ...
  project. Use proactively whenever the user wants to ADD, EDIT, or refactor a test,
  cover an engine effect / attack / ability / trainer, add a playtest or invariant
  case, or debug a red test — including casual phrasings like "เพิ่ม test",
  "เขียนเคสใหม่", "แก้เคสนี้", "cover effect นี้", or just a card / mechanic name.
  Always follows this repo's colocated Vitest conventions.
---

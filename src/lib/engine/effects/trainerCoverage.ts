...
const TRAINER_IMPLEMENTED_KINDS = new Set<ParsedEffect["kind"]>([
  ...
  "trainer_recover_typed_to_hand",
  "trainer_shuffle_typed_to_deck",
  "trainer_both_discard_hand_until",
  "trainer_draw_per_opp_pokemon",
  "trainer_discard_hand_search_three",
  "trainer_devolve_own_typed",
  "trainer_extra_prizes_if_team",
  "trainer_lanas_aid",
  ...
  "stadium_prism_tower",
  "stadium_mystery_garden",
  "stadium_dizzying_valley",
  "stadium_academy_at_night",
  "stadium_levincia",
  "stadium_spikemuth_gym",
  "stadium_surfing_beach",
]);
